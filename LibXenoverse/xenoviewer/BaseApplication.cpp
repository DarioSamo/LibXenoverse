...
bool BaseApplication::configure(void)
{
    ...
    if(mRoot->showConfigDialog())
    {
        ...
        mWindow = mRoot->initialise(true, "XenoviewerApplication Render Window");
...
void BaseApplication::createFrameListener(void)
{
	...
	LONG iconID = (LONG)LoadIcon(GetModuleHandle(0), MAKEINTRESOURCE(IDI_XENOVIEWER_ICON));
	SetClassLong((HWND) windowHnd, GCL_HICON, iconID);
